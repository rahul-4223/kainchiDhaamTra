          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow overflow-hidden">
              ...
              <div className="aspect-w-16 aspect-h-9 bg-gray-100 relative">
                ...
                {/* Traffic Indicators - These would be positioned over the map */}
                ...
                {/* Route Lines */}
                <div className={`absolute top-0 left-0 w-full h-full pointer-events-none ${selectedRoute === 1 ? 'opacity-100' : 'opacity-0'} transition-opacity`}>
                ...
                <div className={`absolute top-0 left-0 w-full h-full pointer-events-none ${selectedRoute === 2 ? 'opacity-100' : 'opacity-0'} transition-opacity`}>
                  <svg className="w-full h-full" viewBox="0 0 800 450">
                ...
                <div className={`absolute top-0 left-0 w-full h-full pointer-events-none ${selectedRoute === 3 ? 'opacity-100' : 'opacity-0'} transition-opacity`}>
                  <svg className="w-full h-full" viewBox="0 0 800 450">
            ...
            {selectedRoute && (
              <div className="mt-6 bg-white rounded-lg shadow p-4">
                ...
                <div className="mt-2 space-y-2">
                  <div className="flex items-center">
                    {getStatusIcon(routes.find(r => r.id === selectedRoute).status)}
                    <span className="text-sm">
                      Current Status: {routes.find(r => r.id === selectedRoute).congestion.charAt(0).toUpperCase() + routes.find(r => r.id === selectedRoute).congestion.slice(1)}
                    </span>
                  </div>
                  <div className="flex items-start">
                    ...
                    <div className="ml-2 space-y-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-gray-500">{routes.find(r => r.id === selectedRoute).name} Entrance</p>
                      </div>
                      <div>
